                ...
                <!--/span-->
                 <div class="span9" id="content">
                     <div class="row-fluid">
                        ...
                        $query = $dbConn->query("SELECT * FROM tbl_transactions INNER JOIN tbl_lessee ON tbl_transactions.lessee_id = tbl_lessee.lessee_id where tbl_lessee.lessee_id = '".$_GET['id']."' ");
